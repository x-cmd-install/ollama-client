...
[![x-cmd/install — ollama-client Code Quality Monitoring Repo Card](https://x-cmd.com/repo-card/ollama-client.svg?lang=zh)](https://x-cmd.com/install/ollama-client)
...
合计: **265,383** 行代码（覆盖前 5 种语言、共 **1548** 个文件）。
...
- **上游仓库**: <https://github.com/Shishir435/ollama-client>
- **官网**: <https://www.ollamaclient.in>
- **许可证**: MIT

## 发布

- **最新版本**: `0.14.0-rc.1` (2026-09-19)
- **最近提交**: 2026-09-20
- **Release 含资产**: 11 个

## 流行度

- **Star**: 64 · **Fork**: 13 · **开放 issue**: 32 · **贡献者**: 2

## 累计统计

- **发布数**: 54 · **已合并 PR**: 345 · **开放 PR**: 1 · **已关闭 issue**: 25 · **开放 issue**: 7 · **提交数**: 1347

## 最近活动

| 时间窗口 | 起始 | 发布 | 已合并 PR | 开放 PR | 已关闭 issue | 开放 issue | 提交 |
|---|---|---:|---:|---:|---:|---:|---:|
| 30d | 2026-08-25 | 5 | 90 | 1 | 3 | 4 | 75 |
| last60d | 2026-07-26 | 13 | 191 | 1 | 5 | 4 | 178 |
| 90d | 2026-06-26 | 21 | 243 | 1 | 7 | 5 | 372 |
| last180d | 2026-03-28 | 32 | 311 | 1 | 17 | 6 | 750 |
| 360d | 2025-09-29 | 38 | 324 | 1 | 19 | 6 | 989 |
| last720d | 2024-10-04 | 54 | 345 | 1 | 25 | 7 | 1347 |
...
ollama-client 的安装元数据由 [x-cmd/install](https://github.com/x-cmd/install) 索引维护——这是一份由 x-cmd 在安装时读取的精选 YAML 包列表。如果 `ollama-client` 缺失、过期，或安装行为有问题，欢迎在该 repo 提 issue 或 PR：

- **提交 issue**: <https://github.com/x-cmd/install/issues/new>
- **编辑包条目**: <https://github.com/x-cmd/install/edit/main/ollama-client.yml>（或索引实际使用的路径）

本页面的数据（card / loc / scorecard / release）由 [x-cmd-install-action](https://github.com/x-cmd-install/x-cmd-install-action) 自动采集，每日重新生成。**安装行为**（版本选择、平台差异、依赖处理）的改进应提交到上游索引。

_数据快照: `data/card/260924.yml` · 2026-09-24T06:07:49Z._
